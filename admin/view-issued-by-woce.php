...
<head>
        ...
        <!-- Title -->
		<title>Manage Issued By WOCE | Body Amaze</title>
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Issued By WOCE</h2>
								<?php
							...
							<div><a href="issued-by-woce.php" class="btn btn-primary btn-icon-text"><i class="fe fe-plus"></i> Add New Issued By WOCE</a></div>
						</div>
						<!-- End Page Header -->
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered text-nowrap" id="example1">
												...
												<tbody>
													<?php
													$i=1;
													$query="select * from media where category='sub_1' order by id desc";
													$row=mysqli_query($con,$query);
													while($record=mysqli_fetch_array($row)){
													?>
														<tr>
															<td><?= $i; ?></td>
															<td><img src="<?= '../'.$record['media_image']; ?>" style="width:100px;"></td>
															...
															<td>
																<div class="btn-icon-list">
																	...
																	<a href="issued-by-woce.php?id=<?= $record['id']; ?>" class="btn ripple btn-primary btn-icon"><i class="fa fa-edit"></i></a>
