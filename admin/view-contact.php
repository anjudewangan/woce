...
<head>
        ...
        <!-- Title -->
		<title>Enquiries | Body Amaze</title>
														...
														<tr>
															...
															<td>
																<div class="btn-icon-list">
																	<a href="query.php?id=<?= $record['id']; ?>&action=del_contact" class="btn ripple btn-danger btn-icon" onclick="return deleteconfig()"><i class="fa fa-trash"></i></a>
																</div>
															</td>
														</tr>
													<?php
