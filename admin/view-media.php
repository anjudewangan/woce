...
<head>
        ...
        <!-- Title -->
		<title>Manage Media | Body Amaze</title>
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Media</h2>
								<?php
							...
							<div><a href="media.php" class="btn btn-primary btn-icon-text"><i class="fe fe-plus"></i> Add New Media</a></div>
						</div>
						<!-- End Page Header -->
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered text-nowrap" id="example1">
												...
												<tbody>
													<?php
													$i=1;
													$query="select * from media where 1 order by id desc";
														...
														<tr>
															...
															<td>
																<div class="btn-icon-list">
																	...
																	<a href="media.php?id=<?= $record['id']; ?>" class="btn ripple btn-primary btn-icon"><i class="fa fa-edit"></i></a>
																	<a href="query.php?id=<?= $record['id']; ?>&action=del_media" class="btn ripple btn-danger btn-icon" onclick="return deleteconfig()"><i class="fa fa-trash"></i></a>
																</div>
															</td>
														</tr>
													<?php
